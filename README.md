...
> [!NOTE]  
> If the run fails at the "HTTP_-_Send_To_DCR" step with a 403 error, verify that the Logic App managed identity has been granted the "Monitoring Metrics Publisher" role on the DCR.
